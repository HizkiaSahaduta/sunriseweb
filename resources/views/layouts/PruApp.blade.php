      ...
      <div class="container">
         <div class="row">
            <div class="col s10 m6 l6">
               <h5 class="breadcrumbs-title mt-0 mb-0"><span>PRU Approval</span></h5>
            ...
            <div class="card">
                <div class="card-content">
                  <p class="caption mb-0">
                    Hello {{ Session::get('USERNAME') }}, here's PRU approval form. Have a good day :)
                    ...
                    <div class="card-title">
                        <div class="row">
                          <div class="col s12 m6 l10">
                            ...
                            <p class="info"><em class="green-text text-darken-4">*green: approved</em>,
                            <em class="red-text text-darken-4"> *red: rejected</em>,
                            <em class="yellow-text text-darken-4"> *yellow: hasn't been approved/rejected</em>
                            </p>
                          </div>
                        </div>
                    </div>
...
<div id="DetailPruModal" class="modal modal-fixed-footer">
    <div id="preloader2" style="display: none"></div>
	<div class="modal-content">

        <div id="DetailPruModalHeader"></div>
        <div id="DetailPruModalInfo"></div>
        <div id="DetailPruModalBody"></div>
    ...
    <div class="modal-footer">
        ...
        {{-- <a href="#!" class="modal-action modal-close btn waves-effect waves-light grey darken-3 z-depth-4">
            Close
        </a> --}}
        </div>
    </div>
...
$(document).ready(function() {
    ...
    $('#PruApp').addClass('active gradient-45deg-green-teal gradient-shadow');
          ...
          swal('Oops!','You must choose Mill ID first','error');
            ...
            .then((willGo) => {
                if (willGo) {
                    ...
                    dom: 'Pfrtip',
                    ajax: {
                    'url':'{!!url("getPruHdr")!!}'+'?mill=' +mill.trim()+allreq,
                    'type': 'post',
                    'headers': {
                    ...
                    columns: [
                        ...
                        {data: 'finish_flag', name: 'finish_flag'},
                        {data: 'aprv_flag', name: 'aprv_flag'},
                        {data: 'reject_flag', name: 'reject_flag'},
                        {data: 'aprv_by', name: 'aprv_by'},
    ...
    $('body').on('click', '#getDetailPru', function(e) {
      e.preventDefault();
      var id1 = $(this).data('id1');
      var pru_id = $(this).data('id2')
      ...
      if (id4 == "Y") {
        ...
        $('#reject').show();
        $('#reset').hide();
        info = "<h6 class='yellow-text text-darken-4'>*Hasn't been approved/rejected</h6>";
      }

      var html = "";
      html = "<input type='hidden' name='send_mill' id='send_mill' value='"+id1+"'>";
      html = html+"<input type='hidden' name='send_pru' id='send_pru' value='"+pru_id+"'>";
      var title = "<h5 class='modal-title'>Detail of "+pru_id+"</h5>";

      $('#DetailPruModalHeader').html(title)
      $('#DetailPruModalBody').html(html);
      $('#DetailPruModalInfo').html(info);
      ...
      if (id3 == 'N') {
        ...
        var dataTable = $('#RawNo').DataTable({
          ...
          dom: 'Pfrtip',
          ajax: {
                  'url':'{!!url("getDetailRawNo")!!}'+'?id1='+id1+ '&id2=' +id2+ '&id3=' +id3,
                  'type': 'post',
                  'headers': {
                  'X-CSRF-TOKEN': '{{ csrf_token() }}'
                  }
        ...
        preloader2.style.display = "block";
          ...
          var dataTable = $('#RawYes').DataTable({
            ...
            dom: 'Pfrtip',
            ajax: {
                  'url':'{!!url("getDetailRawYes")!!}'+'?id1='+id1+ '&id2=' +id2+ '&id3=' +id3,
                  'type': 'post',
                  'headers': {
                  'X-CSRF-TOKEN': '{{ csrf_token() }}'
                  }
    ...
    $('#approve').click(function(e) {
      ...
      var mill =$('#send_mill').val();
      var pru = $('#send_pru').val();

      swal({
      title: "Are you sure",
      text: "Approving PRU ID: "+pru+" ?",
      icon: "warning",
      buttons: true,
      dangerMode: true,
      })
      ...
      if (willGo) {
        ...
        swal("Cancel approval for PRU ID: "+pru);
      }
      });
    ...
    $('#reject').click(function(e) {
        ...
        $.ajax({
            ...
            success: function(result) {
                if(result.errors) {
                    ...
                    swal("Rejection Success", result, "success")
                    $('#example').DataTable().ajax.reload();
                    $('#DetailPruModal').modal('close');
        ...
        swal("Cancel rejection for PRU ID: "+pru);
        }
        });
    });
    ...
    $('#reset').click(function(e) {
        ...
        swal("Cancel resetting for PRU ID: "+pru);
        }
        });
