      ...
      <div class="container">
         <div class="row">
            <div class="col s10 m6 l6">
               <h5 class="breadcrumbs-title mt-0 mb-0"><span>Create PreOrder</span></h5>
      ...
      <div class="card">
        <div class="card-content">
          <div class="card-header">
            ...
            <input type="hidden" id="setBookId">
              ...
              <div class="step-content">
                <div class="row" id="sel_cust">
                    <div class="input-field col s12">
                        ...
                        <select class="browser-default validate" id="search_cust" name="search_cust"></select>
                ...
                <div class="row">
                    <div class="input-field col m6 s12" id="input_id">
                        ...
                        <input type="text" class="validate" id="customerid" name="customerid" placeholder="Customer ID goes here" required readonly="readonly"/>
                        <label>Customer ID <span class="red-text">*</span></label>
                    </div>
                    <div class="input-field col m6 s12" id="input_name">
                        <i class="material-icons prefix">person_pin</i>
                        <input type="text" class="validate" id="customername" name="customername" placeholder="Customer Name goes here" required readonly="readonly"/>
                ...
                <div class="row">
                    <div class="input-field col m6 s12">
                        ...
                        <input type="text" class="validate" id="customeraddress" name="customeraddress" placeholder="Customer Address goes here" required readonly="readonly"/>
                        <label>Customer Address <span class="red-text">*</span></label>
                    </div>
                    <div class="input-field col m6 s12">
                        <i class="material-icons prefix">phone</i>
                        <input type="text" class="validate" id="customerphone" name="customerphone" placeholder="Customer phone goes here" required readonly="readonly"/>
                ...
                <div class="row">
                    ...
                    <div class="input-field col m6 s12">
                        ...
                        <input type="text" class="validate" id="cust_po_num" name="cust_po_num" placeholder="Cust. PO Number goes here"/>
                ...
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <textarea id="remark1" name="remark1" class="materialize-textarea" placeholder="Remark goes here"></textarea>
                        <label>Remark</label>
                    </div>
                </div>
                 <div class="row">
                    <div class="input-field col s12">
                        <i class="material-icons prefix">edit</i>
                        <textarea id="remark2" name="remark2" class="materialize-textarea" placeholder="Remark goes here"></textarea>
              ...
              <div class="step-content">
                ...
                <div class="step-actions">
                  <div class="row">
                    ...
                    <div class="col m4 s12 mb-3">
                      <button class="red btn" id="confirmLater" disabled>
                        <i class="material-icons left">settings_backup_restore</i>
                        Later
                      </button>
                    </div>
                    <div class="col m4 s12 mb-3">
                      <button id="toStep3" class="waves-effect waves dark btn btn-primary green next-step" type="submit" disabled>
                        Submit
                        <i class="material-icons right">arrow_forward</i>
                      </button>
                    </div>
                        ...
                        <div class="card ">
                          <div class="card-content invoice-print-area">
                            <div class="row invoice-date-number">
                              <div class="col xl4 s12">
                                <span class="invoice-number mr-1">BookId#</span>
                                <span id="printBookId">000756</span>
                              </div>
                            ...
                            <div class="row mt-3 invoice-logo-title">
                              <div class="col s12">
                                <h6 class="invoice-from">PT. SUNRISE STEEL</h6>
                            ...
                            <div class="row invoice-info">
                              <div class="col m6 s12">
                                <h6 class="invoice-from">Bill To</h6>
...
{{-- <div id="searchModal" class="modal modal-fixed-footer">
    ...
    <div id="searchForm" style="display: block">
        <p>Here's form to add an item to this order using product search.</p>
        If you wanna adding an item without searching product first, you can use <a href="javascript:void(0)" id="byremark"
        class="green-text animated infinite flash">this</a> instead.</p>
        <br>
        <div class="row">
            <div class="input-field col m6 s12">
                <i class="material-icons prefix">layers</i>
    ...
    <div id="attributForm" style="display: none">
        ...
        <div class="row">
            <div class="input-field col m4 s12">
                <i class="material-icons prefix">confirmation_number</i>
                <input type="number" min="0" step="0" onkeyup="if(this.value<0){this.value= this.value * -1};" id="pct_disc" name="pct_disc" placeholder="% discount goes here"/>
                <label>Discount (%)</label>
            </div>
            <div class="input-field col m4 s12">
                <i class="material-icons prefix">account_balance_wallet</i>
    ...
    <div class="modal-footer">
        <a class="modal-action modal-close btn-small waves-effect waves-light grey darken-3 z-depth-4">
            Close
        </a>
    </div>
</div> --}}
    ...
    if (!cust_id){
        ...
        if (setBookId) {
            ...
            $.ajax({
                ...
                dataType: "json",
                async: true,
                url: "getOrderHeader/id="+setBookId,
                success: function (data) {
...
function listOrderItem() {
    ...
    setBookId = $('#setBookId').val();
    $('#orderItem').DataTable().ajax.url('getItemDetail?id='+setBookId).load();
...
$(document).ready(function() {
    ...
    $('#search_cust').change(function(){
        ...
        $.ajax({
            url: "order_getCustDetails/id="+id,
            type: "GET",
            dataType: 'json',
            success: function(data){
