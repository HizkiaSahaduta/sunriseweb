  ...
  <nav
    ...
    <div class="nav-wrapper">
      ...
      <ul class="navbar-list right">
        ...
        <li class="col s2 m6 l6">
          <a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);"
            data-target="dropdown1">
            <span class="avatar-status avatar-online">
              <img src="{{ asset('outside/material/images/avatar/user.png') }}" alt="avatar"><i></i>
            </span>
          </a>
        </li>
        <!-- <li>
      ...
      <!-- <ul class="dropdown-content" id="translation-dropdown">
        <li class="dropdown-item">
          <a class="grey-text text-darken-1" href="app-invoice-view.html" data-language="en">
            <i class="flag-icon flag-icon-gb"></i>
            English
          </a>
        </li>
        <li class="dropdown-item">
          <a class="grey-text text-darken-1" href="app-invoice-add.html" data-language="fr">
            <i class="flag-icon flag-icon-fr"></i>
            French
          </a>
        </li>
        <li class="dropdown-item">
          <a class="grey-text text-darken-1" href="page-blank.html" data-language="pt">
            <i class="flag-icon flag-icon-pt"></i>
            Portuguese
          </a>
        </li>
        <li class="dropdown-item">
          <a class="grey-text text-darken-1" href="page-blank.html" data-language="de">
      ...
      <li>
            ...
            <a class="grey-text text-darken-1" href="#">
                {{Session::get('GROUPID') }}<span class="badge green">{{ Session::get('SALESID') }}</span>
            </a>
            @else
            <a class="grey-text text-darken-1" href="#">
                {{Session::get('GROUPID') }}
        ...
        <li class="divider"></li>
        <li>
          <a class="grey-text text-darken-2" href="{{ route('logout') }}" onclick="event.preventDefault();
      ...
      <div class="nav-wrapper">
        <form id="navbarForm">
          <div class="input-field search-input-sm">
            <input class="search-box-sm mb-0" type="search" required="" placeholder='Your search key here' id="search"
              data-search="template-list">
