var linearStepper = document.querySelector("#linearStepper"),
    linearStepperInstace = new MStepper(linearStepper, { firstActive: 0, showFeedbackPreloader: !0, autoFormCreation: !0, stepTitleNavigation: !0, feedbackPreloader: '<div class="spinner-layer spinner-blue-only">...</div>' });
linearStepperInstace.resetStepper();
// var horizStepper = document.querySelector("#horizStepper"),
//     horizStepperInstace = new MStepper(horizStepper, { firstActive: 0, showFeedbackPreloader: !0, autoFormCreation: !0, stepTitleNavigation: !0, feedbackPreloader: '<div class="spinner-layer spinner-blue-only">...</div>' });
